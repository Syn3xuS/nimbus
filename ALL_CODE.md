# ALL_CODE.md
Generated: 2026-01-27T16:12:21.119Z
...
```json
{
	...
	"scripts": {
		...
		"start": "next start",
		"lint": "eslint",
		"collect:all": "node scripts/collect_all_code.js"
	},
	"dependencies": {
...
snapshots:
  ...
  eslint-config-next@16.1.3(@typescript-eslint/parser@8.53.0(eslint@9.39.2(jiti@2.6.1))(typescript@5.9.3))(eslint@9.39.2(jiti@2.6.1))(typescript@5.9.3):
    dependencies:
      '@next/eslint-plugin-next': 16.1.3
      eslint: 9.39.2(jiti@2.6.1)
      eslint-import-resolver-node: 0.3.9
