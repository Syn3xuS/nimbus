    ...
    <>
      <Case className={stylesCase.case_center}>
        <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
          <h1 className="text-2xl font-semibold">Ваш диск ждёт вас ☁️</h1>

          <p className="max-w-md text-muted-foreground">
            Войдите в аккаунт, чтобы получить доступ к вашим файлам и дискам,
            которыми с вами поделились другие пользователи.
          </p>
